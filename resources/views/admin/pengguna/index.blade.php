                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('pengguna.create')}}" class="btn btn-primary pull-right">Tambah</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->umur_pengguna}}</td>
                                            <td><a href="{{route('pengguna.edit',$row->id)}}" class="btn btn-primary">Edit</a></td>
                                            <td><form action="{{route('pengguna.destroy',$row->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
