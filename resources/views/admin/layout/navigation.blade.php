            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        ...
                        <a href="{{url('/admin/pengguna')}}"> <i class="menu-icon fa fa-dashboard"></i>Pengguna</a>
                        <a href="{{url('/admin/batuk')}}"> <i class="menu-icon fa fa-dashboard"></i>Batuk</a>
                        <a href="{{url('/admin/obat')}}"> <i class="menu-icon fa fa-dashboard"></i>Obat</a>
                    </li>
